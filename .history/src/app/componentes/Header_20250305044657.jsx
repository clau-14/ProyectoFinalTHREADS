...
const Header = ({ handleOpenModal }) => {
  ...
  return (
   <header className=' relative w-full h-screen  '>
    <article className='  inline-flex border-b-2   w-full items-center justify-center gap-32 -my-72 py-6 mt-1 '>
      <img className='rounded-full w-12' src={user ? user.photoURL  : null} alt="" /> 
      <h1 className=' text-slate-400 -ml-32'>¿Que novedases tienes?</h1>
