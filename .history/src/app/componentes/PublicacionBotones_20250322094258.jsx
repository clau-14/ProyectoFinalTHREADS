...
const PublicacionBotones = ({ publication, currentUser }) => {
  ...
  const handlePublish = (newComments) => {
    const newCommentThreads = newComments
      ...
      .map((comment) => ({
        ...
        text: comment.text,
        userName: currentUser.name, // Nombre del usuario actual
        userPhotoURL: currentUser.photoURL, // Foto del usuario actual
