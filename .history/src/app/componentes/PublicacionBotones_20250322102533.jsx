              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="ml-auto relative group">
                    ...
                    <span className="absolute left-0 -top-6 text-sm bg-gray-600 text-white px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                      Eliminar comentario
                    </span>
                  </div>

                  {/* Alternativa con "..." */}
                  {/* Descomentar esta sección si prefieres "..." */}
                  {/* <div className="ml-auto relative group">
                    <button className="text-gray-500 hover:text-gray-800">...</button>
                    <div className="absolute right-0 mt-2 bg-white border rounded shadow-md hidden group-hover:block">
                      <button
                        onClick={() => handleDeleteComment(comment.id)}
                        className="text-red-500 text-sm px-4 py-2 hover:bg-gray-100 w-full"
                      >
                        Eliminar comentario
                      </button>
                    </div>
