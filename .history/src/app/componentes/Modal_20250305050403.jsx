...
const Modal = ({ show, onClose }) => {
  ...
  <div
    ...
    <label className="flex items-center gap-4 mb-4"><img className='rounded-full w-10' src={user ? user.photoURL  : null} alt="" /> <h1 className=""> {user ? user.displayName : null}</h1></label>
