...
/>
      ...
      <footer className="flex relative justify-center w-full text-gray-400 text-xs mt-16">
        ...
        <section className='flex first-letter:border-2'>
          <p className='absolute -mt-60 ml-52'>Escanea el código para descargar la app</p>
          <img className='absolute -mt-52 ml-64  rounded-lg shadow-md transform transition duration-300 hover:scale-110 hover:shadow-lg' src="/qr.png" alt="" />
        </section>
      </footer>
    </div>
  );
