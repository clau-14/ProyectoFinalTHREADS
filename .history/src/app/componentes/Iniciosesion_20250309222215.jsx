  ...
  */
  ...
  return (
    <div className="container sm:w-full md:w-full lg:w-full xl:w-full flex flex-col items-center justify-center -m-10">
      ...
      <InstagramLogin
  clientId="EAATJPntzLx4BO74UVYY6sgcDJ3wEf6DhZAe2LKgwZB7x1MthM4tHhen44dEuMYaCjZB7Y6kSHkLsEJ5tBx3b1sYxO7LRALOaraD0cOnUGZBtP5cKZAk4ndWfI1G5zxsVTBstXBIZAKcZBimIyvzjMnahLH03DJoX9vD9wR8khzzUjwuspiFjea"
  redirectUri=""
