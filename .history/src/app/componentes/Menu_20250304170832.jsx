...
const Menu = ({ handleOpenModal }) => {
  ...
  return (
    ...
    <ul className="flex flex-col items-center justify-center gap-9 ">
      ...
      <li className="mt-11 hover:bg-gray-200 hover:rounded-lg hover:p-2 hover:text-black active:bg-gray-300 active:text-black"> 
      ...
      <li onClick={handleOpenModal} className=  "p-2 rounded-lg bg-slate-100 hover:bg-gray-200 hover:rounded-lg hover:p-2 hover:text-black active:bg-gray-300 active:text-black">
     <BiPlus /> {/* Icono para agregar una nueva publicación */}
      ...
      <li className="-mt-7  hover:bg-gray-200 hover:rounded-lg hover:p-2 hover:text-black active:bg-gray-300 active:text-black">
        <HiOutlineUser />
      </li>
      </ul>
