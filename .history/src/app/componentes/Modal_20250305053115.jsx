...
const Modal = ({ show, onClose }) => {
  ...
  <div
    ...
    <textarea ref={textareaRef} className="w-full  border-l outline-none focus:ring-0 border-l-gray-200 " type="text" placeholder="¿Que novedases tienes?" rows="5" onInput={handleInput} ></textarea>
  </div>
</div>
  );
};
