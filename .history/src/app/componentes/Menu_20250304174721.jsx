...
const Menu = ({ handleOpenModal }) => {
  ...
  return (
    ...
    <ul className="flex flex-col items-center justify-center gap-10  ">
      ...
      <li className= {`mt-11 ${activeIcon === 'home' ? 'text-black' : ' w-12 h-12 flex items-center justify-centerhover:bg-gray-200 hover:p-1 hover:rounded-lg active:bg-gray-300'}`}
