...
const Modal = ({ show, onClose }) => {
  ...
  <div
    ...
    <textarea ref={textareaRef} className="w-full  border-none outline-none focus:ring-0 border border-2 border-blue-500" type="text" placeholder="¿Que novedases tienes?" rows="5" onInput={handleInput} ></textarea>
  </div>
</div>
  );
};
