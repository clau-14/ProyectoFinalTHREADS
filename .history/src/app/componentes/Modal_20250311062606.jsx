                ...
                <div className="preview-container">
                  {thread.files?.map((file, fileIndex) => (
                    <div key={fileIndex} className="my-2">
                      {file.type === "image" && <img src={file.preview} alt={file.name} className="w-full rounded-md" />}
                      {file.type === "video" && <video src={file.preview} className="w-full rounded-md" controls />}
                      {file.type === "file" && <p className="text-gray-500">Archivo adjunto: {file.name}</p>}
                    </div>
                  ))}
                </div>
