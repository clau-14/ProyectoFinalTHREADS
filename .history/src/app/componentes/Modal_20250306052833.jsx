...
const Modal = ({ show, onClose }) => {
  ...
  // Habilitar el botón de "Publicar" si hay contenido en alguno de los hilos
      ...
      <div
        ...
        {threads.map((thread, index) => (
         ...
         <section className="flex justify-between items-center pt-4">
          ...
          <button
            className={`px-4 py-2 rounded-lg ${isPublishEnabled ? 'bg-blue-500 text-white' : 'bg-gray-300 text-gray-500'}`}
