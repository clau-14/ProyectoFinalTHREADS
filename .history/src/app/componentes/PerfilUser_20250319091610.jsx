    ...
    <header className="relative w-full h-screen">
      <article className=" inline-flex w-full items-center justify-center  -my-72 py-6 mt-1">
        ...
        <div className="flex justify-center border-b-2 w-full gap-36 mt-2   text-slate-500">
          <button className=" hover:text-black focus:text-black focus:underline focus:decoration-[2px] focus:underline-offset-4 z-10 after:w-96 after:h-[2px]">Hilo</button>
