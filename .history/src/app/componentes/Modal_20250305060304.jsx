...
const Modal = ({ show, onClose }) => {
  ...
  <div
    ...
    <label className="flex items-center gap-4 -mb-4 "><img className='rounded-full w-10  -ml-2 mt-2 z-40' src={user ? user.photoURL  : null} alt="" /> <h1 className=""> {user ? user.displayName : null}</h1></label>
    <textarea ref={textareaRef} className="w-full border-l-4 ml-4 pl-3 outline-none focus:ring-0 
