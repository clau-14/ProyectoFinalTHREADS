  ...
  return (
    <section className="relative w-full h-min-screen">  
      <div className=" inline-flex w-full items-center justify-center  -my-72 py-6 mt-1">
        ...
        <div className="flex flex-row  justify-center gap-6 p-5 -mt-96">
          
  {/* Tarjeta 1 */}
  <div className="flex flex-col justify-center items-center bg-white border border-gray-200 shadow-lg rounded-lg h-80 max-w-xs p-5">
     <SlNote />
    <h2 className="font-bold text-xl text-gray-800 mt-4">Crear hilo</h2>
    <p className="text-gray-600 mt-2 text">
