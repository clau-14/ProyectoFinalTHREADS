...
const PublicacionBotones = ({ publication }) => {
  ...
  const { user } = useUserStore(); // Datos del usuario actual
              ...
              >
                ...
                <div className="flex gap-4 mt-2">
                  ...
                  <button
                    ...
                    className="transition-transform transform hover:scale-110 text-grey-200"
                  >
                    <FaRegComment />
                  </button>
                  <button
                    onClick={() => console.log("Reposteo en comentario")}
                    className="transition-transform transform hover:scale-110 text-grey-400"
                  >
                    <BiRepost />
                  </button>
                  <button
