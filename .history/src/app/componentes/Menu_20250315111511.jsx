...
const Menu = ({ handleOpenModal }) => {
  ...
  const [showLogout, setShowMenu] = useState(false); // Controlar el cuadro emergente
  ...
  return (
    ...
    <ul className="flex flex-col items-center justify-center gap-7   ">
     ...
     <BiPlus /> {/* Icono para agregar una <IoHeartDislikeOutline />nueva publicación */}
      ...
      {/* Menú desplegable */}
      {showMenu && (
        <ul className="absolute top-10 right-0 bg-white border border-gray-300 rounded-md shadow-lg z-10 w-48">
