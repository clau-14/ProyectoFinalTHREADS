...
const PerfilUser = () => {
  ...
  return (
    <section className="relative w-full min-h-screen bg-slate-100">
    <div className="inline-flex w-full items-center justify-center -my-72 py-6 mt-1">
      ...
      <img
        className="rounded-full w-12 ml-72"
        src={user?.photoURL || ""}
    ...
    <div className="flex justify-center gap-5 mt-10 -mb-5">
      ...
      <button className="ml-80 text-xl">
        <CgNotes />
      </button>
    ...
    <div className="flex justify-center">
      <button className="mb-5 border border-slate-200 rounded-lg px-60 py-1 mt-10 font-bold text-slate-400">
        Editar Perfil
      </button>
    </div>
    <div className="flex justify-center border-b-2 w-full gap-36 mt-4 pb-1 text-slate-500">
      <button className="hover:text-black focus:text-black focus:underline focus:decoration-[1.5px] focus:underline-offset-8">
        Hilo
      </button>
      <button className="hover:text-black focus:text-black focus:underline focus:decoration-[1.5px] focus:underline-offset-8">
        Respuestas
