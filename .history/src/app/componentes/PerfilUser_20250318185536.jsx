...
const PerfilUser = ({ handleOpenModal }) => {
  ...
  return (
    <header className="relative w-full h-screen">
      <article className=" inline-flex w-full items-center justify-center gap-36 -my-72 py-6 mt-1">
        ...
        <button className="mb-5 border border-slate-200 rounded-lg px-60 py-1 mt-10 font-bold text-slate-40000" >
          Editar Perfil
        </button>
        </div>
