...
export default function Perfil() {
  ...
  return (
    ...
    {/* Contenido principal */}
    <div className='flex flex-col items-center justify-center mi-h'>
      <section>
      ...
      <section className='container bg-white flex-col items-center justify-center w-2/5 h-full gap-2 rounded-3xl fixed mt-32'>
        <PerfilUser/>
      </section>
    </div>
  </div>
