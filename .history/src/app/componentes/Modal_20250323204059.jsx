...
const Modal = ({ show, onClose, onPublish, editingPost, onAddPost  }) => {
  ...
  const handlePublish = async () => {
    ...
    const content = threads
      .filter((thread) => thread.content.trim() !== "") // Filtramos hilos con contenido vacío
      .map((thread) => ({
    ...
    try {
      await handleAddPost(content, user.uid); // Aquí se usa `createPost` dentro de `handleAddPost`
