...
const Modal = ({ show, onClose, onPublish, editingPost, onAddPost  }) => {
  ...
  const handlePublish = async () => {
    ...
    const content = threads
      .filter((thread) => thread.content.trim() !== "") // Eliminamos hilos vacíos
      .map((thread) => ({
        text: thread.content.trim(), // Removemos espacios
    ...
    console.log("Contenido procesado para publicación:", content);
    try {
