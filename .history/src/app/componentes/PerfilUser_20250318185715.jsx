...
const PerfilUser = ({ handleOpenModal }) => {
  ...
  return (
    <header className="relative w-full h-screen">
      <article className=" inline-flex w-full items-center justify-center gap-48 -my-72 py-6 mt-1">
        <h1 className="text-slate-400 -ml-28">
          {user.displayName || "Invitado"} {/* Mostrar el nombre del usuario */}
        </h1>
        <img className="rounded-full w-12 right-80" src={user.photoURL || ""} alt="" /> {/* Mostrar la foto del usuario */}
        </article>
