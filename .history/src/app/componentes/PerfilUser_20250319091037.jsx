  ...
  return (
    <header className="relative w-full h-screen">
      <article className=" inline-flex w-full items-center justify-center  -my-72 py-6 mt-1">
        ...
        <button className="relative text-gray-800 hover:text-blue-600 focus:text-blue-600 px-4 py-2">
        Botón 1
        <span className="absolute left-0 right-0 -bottom-2 h-[2px] bg-blue-600 hidden focus:inline-block"></span>
      </button>
