...
const Modal = ({ show, onClose }) => {
  ...
  const handleAddThread = (index) => {
    ...
    newThreads[index].showUser = true; // Muestra el nombre del usuario
    if (index === newThreads.length - 1) {
      newThreads.push({ id: newThreads.length + 1, active: false, placeholder: "¿Di algo más?", showUser: false, content: "" }); // Agrega un nuevo hilo inactivo
    }
    setThreads(newThreads);
  };
