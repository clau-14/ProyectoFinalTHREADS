...
import { auth } from "@/firebase/firebaseConfig";// Importa la app inicializada


const auth = getAuth(app); // Usa la configuración inicializada

export default function Perfil() {
  const [user, setUser] = useState(null);

  useEffect(() => {
    const auth = getAuth(app); // Usa la app inicializada aquí
