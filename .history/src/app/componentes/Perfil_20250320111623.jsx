   ...
   const [showModal, setShowModal] = useState(false); // Mostrar o no el modal
    ...
    const handlePublishContent = (content) => {
      if (user && user.displayName && user.photoURL) {
        ...
        const storedPosts = JSON.parse(localStorage.getItem('publishedContent')) || [];
        localStorage.setItem('publishedContent', JSON.stringify([...storedPosts, newPost]));
    
        setPublishedContent([...storedPosts, newPost]); // Actualiza el estado local
      } else {
