...
/>
      ...
      <footer className="flex relative justify-center w-full text-gray-400 text-xs mt-16">
        ...
        <section className='flex'>
          ...
          <div className='border-2'><img className='absolute -mt-52 ml-64 p-2 rounded-lg shadow-md transform transition duration-300 hover:scale-110 hover:shadow-lg' src="/qr.png" alt="" /></div>
        </section>
      </footer>
    </div>
  );
