...
const Modal = ({ show, onClose }) => {
  ...
  const handleRemoveThread = (index) => {
    ...
    if (newThreads.length === 1 && newThreads[0].id === 1) {
      newThreads.push({ id: 2, active: false, placeholder: "¿Di algo más?", showUser: false }); // Asegura que el segundo hilo siempre esté presente y desactivado
          }
    setThreads(newThreads);
  };
