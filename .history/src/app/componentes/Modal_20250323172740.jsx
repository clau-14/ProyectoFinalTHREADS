...
const Modal = ({ show, onClose, onPublish, editingPost, onAddPost  }) => {
  ...
  const handlePublish = async () => {
    ...
    const content = threads
      .filter((thread) => thread.content.trim() !== "") // Filtramos los hilos con contenido vacío
      .map((thread) => ({
        text: thread.content.trim(), // Eliminamos espacios innecesarios
    ...
    try {
      ...
      // Reinicia el estado después de publicar
