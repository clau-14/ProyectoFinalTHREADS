...
const Menu = ({ handleOpenModal }) => {
  ...
  return (
    ...
    <ul className="flex flex-col items-center justify-center gap-9 hover:bg-gray-00 hover:rounded-lg hover:p-2 hover:text-black active:bg-gray-300 active:text-black">
