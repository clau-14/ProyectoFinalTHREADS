  ...
  >
    ...
    {thread.active && (
      <>
        ...
        {/* Contenedor para previsualizar archivos */}
...
{/* Sección final con botón "Publicar" */}
<section className="flex justify-between items-center pt-4">
  ...
  <button
    className={`px-4 py-2 rounded-lg ${
      isPublishEnabled
        ? " text-black border-2 border-gray-200 rounded-lg font-bold"
        : "text-grey-300 border-2 text-gray-400"
    }`}
