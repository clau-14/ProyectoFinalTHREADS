...
const Modal = ({ show, onClose, onPublish }) => {
  ...
  const handleInput = (index, event) => {
    ...
    // Agrega un nuevo hilo automáticamente si se escribe en el último hilo
    ...
    // Verifica si algún hilo tiene contenido para habilitar "Publicar"
  ...
  const handleRemoveThread = (index) => {
    ...
    if (index === 1) {
      ...
      if (newThreads.length > 1) {
        ...
        currentThread.files.splice(fileIndex, 1);
      }
          }
    setThreads(newThreads);
  };
