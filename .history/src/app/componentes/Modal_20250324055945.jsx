...
const Modal = ({ show, onClose, onPublish, editingPost, onAddPost  }) => { //onAddPost desactivado
  ...
  const handlePublish = async () => {
    ...
    try {
      if (editingPost) {
        // Verifica que editingPost contenga un ID válido
        if (!editingPost.id) {
      ...
      // Maneja el error sin interrumpir el flujo de edición
      console.error("Error durante la publicación:", error);
      alert(`Ocurrió un problema: ${error.message}`); // Mostrar mensaje al usuario
    }
  };
