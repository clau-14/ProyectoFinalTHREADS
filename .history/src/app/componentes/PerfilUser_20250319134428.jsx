...
const PerfilUser = () => {
  ...
  <div className="flex flex-col justify-center items-center bg-slate-100 border border-gray-200 shadow-lg rounded-lg h-60 max-w-xs ">
    ...
    <button onClick={handleOpenModal}  className="mt-10 w-28 bg-black text-white py-2 rounded-lg "   <Modal show={showModal} onClose={handleCloseModal} onPublish={handlePublishContent} />>
      Crear
    </button>
  </div>
