...
const Modal = ({ show, onClose, onPublish }) => {
  ...
  const handleInput = (index, event) => {
    ...
    // Activa el siguiente hilo si se ingresa texto en el último hilo
  ...
  const handleAddThread = () => {
    const newThreads = [...threads];
    newThreads.push({ id: newThreads.length + 1, active: true, placeholder: "¿Di algo más?", content: "", files: [] });
    setThreads(newThreads);
  };
