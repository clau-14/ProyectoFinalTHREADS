  ...
  return (
    <section className="relative w-full h-min-screen">  
      <div className=" inline-flex w-full items-center justify-center  -my-72 py-6 mt-1">
        ...
        <div className="flex flex-row  justify-center gap-6 p-5 -mt-64 text-">
          
  {/* Tarjeta 1 */}
  <div className="flex flex-col justify-center items-center bg-white border border-gray-200 shadow-lg rounded-lg h-64 max-w-xs p-5">
     <SlNote />
