...
export default function ContenidoPage() {
  ...
  // Cargar contenido de localStorage al montar el componente
  useEffect(() => {
  ...
  return (
    <div className='relative w-full h-screen'>
      ...
      <div className='flex flex-col items-center justify-center h-full'>
        ...
        <section style={{ overflowY: 'auto', msOverflowStyle: 'none', scrollbarWidth: 'none' }} className='container bg-white flex flex-col items-center justify-center w-2/5 h-full gap-2 rounded-3xl fixed mt-32'>
