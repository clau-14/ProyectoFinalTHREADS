...
export default function ContenidoPage() {
  ...
  const handlePublishContent = (updatedContent) => {
    if (editingPost !== null) {
      // Actualizamos la publicación editada
      const updatedPosts = publishedContent.map((post, index) =>
        index === editingPost.index
          ? { ...post, content: updatedContent } // Reemplazamos el contenido editado
          : post
      );
      setPublishedContent(updatedPosts); // Actualizamos el estado
      console.log("Publicación editada:", updatedPosts);
    } else {
      console.error("Error: No se pudo editar la publicación porque no hay nada seleccionado.");
    }
  
    setShowModal(false); // Cerramos el modal
    setEditingPost(null); // Reseteamos el estado de edición
  };
