  ...
  if (editingPost !== null) {
   ...
   return (
     <div className='relative w-full h-screen'>
       ...
       {showModal && (
         <Modal show={showModal} onClose={handleCloseModal} onPublish={editingPost ? handleSaveEditFromModal : handlePublishContent} defaultValue={editingPost?.content[0]?.text || ""}/>
       )}
     </div>
   );
}
