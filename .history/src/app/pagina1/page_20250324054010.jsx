...
export default function ContenidoPage() {
 ...
 const handleEditPost = (index) => {
  const postToEdit = publishedContent[index]; // Obtenemos la publicación seleccionada
  if (postToEdit) {
    setEditingPost(postToEdit); // Pasamos la publicación al modal
    setShowModal(true); // Mostramos el modal
  } else {
    console.error("Error: La publicación seleccionada no contiene datos.");
  }
};
