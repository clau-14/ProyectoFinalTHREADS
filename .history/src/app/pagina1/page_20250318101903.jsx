...
const handleDeletePost = (index) => {
  ...
  toast.success("¡La publicación fue eliminada con éxito!", {
    ...
    closeOnClick: true,    // Se cierra al hacer clic en ella
    pauseOnHover: true,    // Pausa al pasar el ratón
    draggable: true,       // Permite arrastrarla
    progress: undefined,   // Usa el progreso predeterminado
  });
};
   ...
   return (
     <div className='relative w-full h-screen'>
        <Toaster position="top-c" reverseOrder={false} toastOptions={{ duration: 3000 }} />
