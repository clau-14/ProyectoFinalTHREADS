...
export default function ContenidoPage() {
   ...
   const handlePublishContent = (content) => {
    if (user) {
      {
        console.log("Publicando contenido con el usuario:", user);
      }
      const newPost = {
        content,
       ...
       <div className='flex flex-col items-center justify-center h-full'>
         ...
         <section style={{ overflowY: 'auto', msOverflowStyle: 'none', scrollbarWidth: 'none' }} 
           ...
           {publishedContent.map((post, index) => (
              ...
              <img
              className='rounded-full w-10 -ml-2 mt-2 z-40'
              src={post.userPhoto || "default-placeholder.jpg"} // Mostrar un placeholder si no hay foto
              alt="Foto de usuario"/>
