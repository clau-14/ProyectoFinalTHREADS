  ...
  toast.success("¡La publicación fue eliminada con éxito!", {
   ...
   return (
     <div className='relative w-full h-screen'>
       ...
       <button className='absolute right-12 bottom-5 bg-white rounded-xl border-2 p-7 shadow-lg text-2xl font-bold'><BiPlus /></button>
       {showModal && (
         <Modal show={showModal} onClose={handleCloseModal} onPublish={handlePublishContent}  editingPost={editin onClick={handleOpenModal}gPost} />
       )}
     </div>
   );
}
